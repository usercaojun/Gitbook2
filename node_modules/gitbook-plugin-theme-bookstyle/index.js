...
module.exports = {
    ...
    hooks: {
        finish: function () {
            var configOption = this.config.get('pluginsConfig')['theme-bookstyle'];
            ...
            if(pathFile){
                ...
                var pluginLogoPath = path.join(process.cwd(), output, 'gitbook','gitbook-plugin-theme-bookstyle',"logo.png");
